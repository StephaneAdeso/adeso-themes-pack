...
export function getColors(p: Palette): any {
  return {
    ...
    "activityBarBadge.background": p.ui.activityBar.iconBadgeBackground,
    "activityBarBadge.foreground": p.ui.activityBar.iconBadgeForeground,
    ...
    "statusBarItem.activeBackground": p.ui.statusBar.itemActiveBackground,
    "statusBarItem.errorBackground": p.ui.statusBar.itemErrorBackground,
    "statusBarItem.errorForeground": p.ui.statusBar.itemErrorForeground,
    "statusBarItem.focusBorder": p.ui.statusBar.itemFocusBorder,
    "statusBarItem.hoverBackground": p.ui.statusBar.itemsHoverBackground,
    "statusBarItem.remoteBackground": p.ui.statusBar.itemRemoteBackground,
    "statusBarItem.remoteForeground": p.ui.statusBar.ItemRemoteForeground,
    "statusBarItem.warningBackground": p.ui.statusBar.itemWarningBackground,
    "statusBarItem.warningForeground": p.ui.statusBar.itemWarningForeground,
