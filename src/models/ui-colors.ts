...
export function getColors(p: Palette): any {
  return {
    ...
    "editorIndentGuide.activeBackground1": p.ui.editor.indentLineColor,
    "editorIndentGuide.background1": p.ui.editor.lineSeparator,
    ...
    "editorOverviewRuler.border": p.ui.editor.lineSeparator,
